...
const Owners = ({ onNext, onPrev, value, onChange }) => {
    const options = ["Single", "Multiple", "Not Sure"];

    const handleSelect = (option) => {
        onChange('owners', option);
    };

    return (
        <div className="w-full">
            <h3 className="text-xl md:text-2xl font-semibold mb-6 text-white">How Many Owners will be involved?</h3>
