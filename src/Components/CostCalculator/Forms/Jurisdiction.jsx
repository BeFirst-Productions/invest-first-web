...
const Jurisdiction = ({ onNext, onPrev, value, onChange }) => {
    const options = ["Dubai Mainland", "Freezone", "Not Sure"];

    const handleSelect = (option) => {
        onChange('jurisdiction', option);
    };

    return (
        <div className="w-full">
            <h3 className="text-xl md:text-2xl font-semibold mb-6 text-white">Which Jurisdiction are you looking for?</h3>
