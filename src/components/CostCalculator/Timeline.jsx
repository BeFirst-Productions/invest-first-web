    ...
    return (
        <>
            ...
            <div className="block md:hidden w-full mb-8">
                <div className="relative flex items-center justify-between w-full px-2">
                    ...
                    <div
                        ...
                        className="absolute left-0 top-1/2 -translate-y-1/2 h-[2px] bg-[#0099CC] z-10 origin-left"
                        style={{ width: "0%" }}
                    />
                  ...
                  `}
                                ...
                                <div
                                  ...
                                  `}
                                >
                                    <span className="text-[#0099CC] font-bold">{step.title}</span>
                                </div>
                            </div>
                        );
                    })}
            ...
            <div className="hidden md:flex relative flex-col items-center w-full min-h-[400px]">
                ...
                <div
                    ref={lineRef}
                    className="absolute left-1/2 top-0 w-[2px] bg-[#0099CC] -translate-x-1/2 origin-top"
                    style={{ height: "0%" }}
                />
                ...
                <div className="flex flex-col justify-between h-full w-full space-y-12 py-2">
                    ...
                    `}
                        ...
                        ${isActive ? "text-[#0099CC] font-bold" : ""}
