            ...
            <SectionContainer>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 mb-12 md:mb-20 items-end">
                    <div className="md:col-span-5 lg:col-span-4">
                        <h2 className="text-3xl md:text-[2.5rem] font-bold leading-tight text-black">
                    ...
                    <div className="md:col-span-7 lg:col-span-8 flex justify-start md:justify-end">
                        <p className=" text-sm md:text-base leading-relaxed max-w-2xl text-left md:text-right text-black">
