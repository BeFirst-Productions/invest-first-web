...
const Sidebar = () => {
    const latestPosts = [
        { title: "Lorem ipsum dolor sit amet", date: "11 JAN 2024", image: "/images/blog/blog-1.png" },
        { title: "Donec ipsum dolor sit amet", date: "11 JAN 2024", image: "/images/blog/blog-1.png" },
        { title: "Lorem ipsum dolor sit amet", date: "11 JAN 2024", image: "/images/blog/blog-1.png" },
        { title: "Donec ipsum dolor sit amet", date: "11 JAN 2024", image: "/images/blog/blog-1.png" },
    ];
            ...
            <div className="bg-[#0b1221] border border-[#0099CC] rounded-2xl p-6 lg:p-8">
                ...
                <div className="space-y-6">
                    {latestPosts.map((post, idx) => (
                        <Link href={`/blogs/post-${idx + 1}`} key={idx} className="flex items-center gap-4 group cursor-pointer">
