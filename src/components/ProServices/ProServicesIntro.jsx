...
const ProServicesIntro = ({ data }) => {
    ...
    return (
        <section className="relative w-full py-10 md:py-20 overflow-hidden text-black">
                ...
                <div className="  relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-3 text-gray-700 text-sm md:text-base leading-relaxed font-light">
