    ...
    return (
        <SectionContainer className="py-10 md:py-20">
                ...
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-3xl md:text-[2.5rem] font-bold bg-clip-text text-transparent bg-linear-to-r from-cyan-500 to-black">
                        <span className="text-[#0099CC] ">{proServicesData.title.highlight}</span> <span className="text-black">{proServicesData.title.rest}</span>
                    </h2>
                    <p className=" max-w-2xl text-black mx-auto text-base md:text-lg leading-relaxed">
                ...
                <div className="text-center">
                    <p className=" max-w-3xl mx-auto text-sm md:text-base leading-relaxed  text-black">
