...
const VisaServices = () => {
    ...
    return (
        <SectionContainer ref={sectionRef} className="w-full py-16 md:py-24">
                {/* Header- Centered */}
                <div className="text-center mb-12 space-y-4 visa-header">
                    <h2 className="text-3xl md:text-4xl font-bold text-black">{visaSectionData.heading}</h2>
                    <p className=" max-w-2xl mx-auto text-base md:text-lg text-black">
