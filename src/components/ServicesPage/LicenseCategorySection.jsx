        ...
        <section className="relative w-full py-10 md:py-20   overflow-hidden">
            ...
            <SectionContainer>
                ...
                <div className="text-center mb-16 relative z-10 space-y-4">
                    <h2 className="text-3xl md:text-[2.5rem] font-bold text-black leading-tight max-w-lg mx-auto">
                ...
                <div ref={containerRef} className="hidden lg:flex flex-col gap-6  relative z-10">
                    {licenseSectionData.licenseList.map((item) => (
                        ...
                        >
                            ...
                            {/* CENTER — IMAGE */}
                            <div className="flex-[0.2] flex items-center   justify-center bg-[rgb(0,15,43)] group-hover:bg-[#660033] transition-colors duration-300">
                                <div className="w-full h-full mb-5  flex  justify-center items-center bg-white rounded-b-3xl">
                            ...
                            <div className="flex-[0.5] animate-width-right flex justify-center items-center rounded-t-3xl px-8 py-6 bg-[#000F2B] group-hover:bg-[#660033] transition-colors duration-300 overflow-hidden">
                                <p className="text-white text-sm md:text-base  leading-relaxed max-w-sm flex-none text-center">
                                    {item.description}
                                </p>
                            </div>
                        </div>
