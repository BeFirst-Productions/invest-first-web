  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          ref={leftCardRef}
          className="order-1 relative w-full max-w-[320px] lg:w-[200px] xl:w-[280px] flex-shrink-0 aspect-[4/5] lg:aspect-auto rounded-[32px] z-0 overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.12)]"
        >
          <div className="relative w-full h-full">
            <Image 
              src="/images/founders/we-start.jpg" 
              alt="Since 2018" 
              fill 
