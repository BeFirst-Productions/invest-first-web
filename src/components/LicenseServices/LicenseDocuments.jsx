        ...
        <SectionContainer className="py-10 md:py-20 ">
                <div className="">
                    ...
                    <div className="mb-10 md:mb-16">
                        <h2 className="text-3xl md:text-4xl text-black  font-semibold leading-tight max-w-xl 2x:max-w-2xl">
                            Documents <span className="text-[#0099CC]">{data.titleHighlight}</span> {data.titleText}
                        </h2>
                        <p className=" mt-6 text-sm md:text-base lg:text-lg max-w-4xl leading-relaxed text-black">
                            {data.description}
                        </p>
                    </div>
