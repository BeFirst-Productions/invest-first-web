        ...
        <SectionContainer className="py-10 md:py-20 ">
                <div className="">
                    ...
                    <div className="mb-12 md:mb-20">
                        <h2 className="text-3xl md:text-4xl text-black font-semibold max-w-xl 2xl:max-w-2xl  leading-tight">
                            <span className="text-[#0099CC]">{data.titleHighlight}</span> {data.titleText}
                        </h2>
                        <p className=" mt-6 text-black text-sm md:text-base lg:text-lg max-w-3xl leading-relaxed">
                            {data.description}
                        </p>
                    </div>
