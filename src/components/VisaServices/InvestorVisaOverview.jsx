    ...
    return (
        <SectionContainer className="py-10 md:py-20">
            <div className="">
                ...
                <div className="relative border border-[#00AEEF]/40 rounded-[24px] md:rounded-[40px] px-4 py-10 pt-12 md:p-16 bg-[#000F2B] backdrop-blur-sm shadow-xl">

                    {/* Notched Title Tab */}
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-4 md:px-0 md:w-auto flex justify-center">
                        <div className="relative w-full max-w-[340px] md:max-w-none md:w-auto inline-flex justify-center px-4 py-4 md:px-10 md:py-5 rounded-[20px] md:rounded-2xl border border-[#00AEEF]/40 bg-[#000F2B] shadow-xl z-10">
