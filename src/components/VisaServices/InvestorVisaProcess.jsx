    ...
    return (
        <SectionContainer className="py-10 md:py-20">
            <div className="max-w-7xl mx-auto px-4 ">
                {/* Process Box */}
                <div className="relative border border-[#00AEEF]/40 rounded-[30px] p-8 md:p-12 bg-[#000F2B] backdrop-blur-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Footer Note */}
                        <div className="pt-6">
                            <p className="text-white text-lg md:text-xl font-medium border-b border-[#00AEEF]/40 pb-1 inline-block">
                                {footer}
                            </p>
                        </div>
                    </div>
