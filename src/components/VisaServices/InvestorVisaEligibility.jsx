    ...
    return (
        <SectionContainer className="py-10 md:py-20 ">
            ...
            <div className="text-center mb-12 md:mb-16 max-w-7xl mx-auto ">
                <h2
                    className="text-3xl md:text-4xl font-semibold text-black   mb-6 leading-tight"
                    dangerouslySetInnerHTML={{ __html: title }}
                />
                <p className="text-black text-base md:text-lg max-w-2xl mx-auto border-b border-[#00AEEF]/30 pb-4 inline-block">
                    {description}
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-8xl mx-auto px-4">
                {cards.map((cardText, index) => (
                    <div
                        key={index}
                        className="bg-[#000F2B] border border-[#00AEEF]/40 rounded-2xl p-8 md:p-10 flex items-center justify-center text-center transition-all duration-300 hover:border-[#00AEEF] hover:shadow-[0_0_20px_rgba(0,174,239,0.15)] group"
                    >
            ...
            <div className="text-center mt-12 md:mt-16 max-w-3xl mx-auto ">
                <p className=" text-black text-base md:text-lg leading-[1.8] font-normal">
                    {footer}
                </p>
            </div>
        </SectionContainer>
