...
const virtualPRO = {
  ...
  intro: {
    ...
    description1:
      "Virtual PRO services support businesses by handling all government documentation and approvals without the need for an in-house PRO. These services cover trade license processing, employment visas, Emirates ID coordination, labour and immigration applications, medical typing, and document attestation.",
    description2:
      "By working with authorities such as the General Directorate of Residency and Foreigners Affairs and the Ministry of Human Resources and Emiratisation, Virtual PRO providers ensure accurate submissions, faster approvals, and full regulatory compliance.",
    description3:
      "This helps startups, SMEs, and foreign investors save time, reduce operational costs, and focus on core business activities while professionals manage all administrative procedures efficiently.",
    image: "/images/proServices/virtual-pro.png",
  },
  bannerTitle: "Virtual PRO",
  bannerDescription:
    "Streamline your government transactions with our professional Virtual PRO services.",
  cardTitle: "Efficient Government Relations",
  cardDescription:
    "Dedicated PRO officers handling all your document processing and compliance.",
  seo: {
    title: "Virtual PRO Services in UAE |  PRO Services in Dubai",
    description:
  ...
  companyFormationTypes: {
    ...
    description:
      "We provide comprehensive Virtual PRO support across all government departments:",
    items: [
      {
        id: "01",
        title: "Trade License Services",
        description:
          "New license application, renewals, amendments, and activity additions with mainland and free zone authorities.",
      },
      {
        id: "02",
        title: "Visa Processing Services",
        description:
          "Employment visas, investor visas, family visas, visa renewals, cancellations, and status change support.",
      },
      {
        id: "03",
        title: "Labour & Immigration Approvals",
        description:
          "Work permits, labour quota approvals, offer letters, and coordination with the Ministry of Human Resources and Emiratisation and General Directorate of Residency and Foreigners Affairs.",
      },
      {
        id: "04",
        title: "Emirates ID Services",
        description:
          "Application typing, biometric appointments, renewals, and replacements.",
      },
      {
        id: "05",
        title: "Company Formation PRO Support",
        description:
          "End-to-end PRO assistance for mainland, free zone, and offshore company setup.",
      },
    ],
  },
  whyChoose: {
    ...
    cardTitle:
      "Why Invest First Is a Leading Virtual PRO Service Provider in the UAE?",
    ...
    items: [
      {
        ...
        answer:
          "Virtual PRO services are remote government liaison and documentation support services that handle visas, labour approvals, license renewals, Emirates ID processing, and other compliance tasks without the need for a physical PRO at your office. They act as your official representative with UAE authorities.",
      },
      {
        question: "What is the role of a PRO in the UAE?",
        answer:
          "A PRO (Public Relations Officer) manages all government-related paperwork, including visa applications, labour contracts, immigration approvals, and trade license processes, ensuring your business stays compliant with UAE regulations.",
      },
      {
        question: "Who needs Virtual PRO services?",
        answer:
          "Virtual PRO services are ideal for: Startups and SMEs, Free zone and mainland companies, Foreign investors and NRI business owners, Freelancers and remote businesses, and Companies without an in-house PRO. They help businesses operate smoothly without handling complex government procedures themselves.",
      },
      {
        question: "How is a Virtual PRO different from an in-house PRO?",
        answer:
          "A Virtual PRO works remotely and on demand, while an in-house PRO is a full-time employee. Virtual PRO services are more cost-effective for startups and SMEs because you only pay for the services you use.",
      },
      {
        question: "Is Virtual PRO service cost-effective?",
        answer:
          "Yes. It eliminates the need for hiring a full-time PRO, reduces internal HR workload, and helps avoid penalties caused by missed renewals or incorrect submissions.",
      },
    ],
  },
  authorizedPartnerStatus: {
    ...
    description:
      "Invest First delivers faster and fully compliant Virtual PRO services across the UAE. Our direct coordination with free zone authorities eliminates intermediaries, reduces delays, and ensures accurate submission of all government documentation.",
    bulletPoints: [
    ...
    footerNote:
      "This strong partnership allows us to manage your trade licenses, visas, Emirates ID, labour, and immigration processes efficiently while helping you avoid penalties and operational delays.",
  },
};
...
const localSponsorships = {
  ...
  intro: {
    ...
    description1:
      "Local sponsorship services in the UAE enable foreign investors to establish mainland companies by appointing a UAE national as a local sponsor or service agent, in accordance with regulatory requirements.",
    description2:
      "These services ensure full legal compliance, smooth license approvals, and seamless coordination with government authorities—allowing business owners to operate confidently without administrative complexity.",
    description3:
      "By working with authorities such as the Department of Economic Development, Ministry of Human Resources and Emiratisation, and General Directorate of Residency and Foreigners Affairs, local sponsorship providers facilitate trade license issuance, immigration file opening, labour quotas, and regulatory approvals.This structured support helps startups, SMEs, and international investors save time, reduce risk, and focus on business growth while all legal formalities are managed professionally.",
    image: "/images/proServices/local-sponsorship.png",
  },
  bannerTitle: "Local Sponsorships",
  bannerDescription:
    "Reliable and legally secure local sponsorship solutions for your mainland business.",
  cardTitle: "Trusted UAE Partnerships",
  cardDescription:
    "Protect your business control and profits with our vetted local sponsors.",
  seo: {
    ...
    canonical:
      "http://investfirst.ae/services/pro-services/local-sponsership-uae",
    image: "/assets/images/pro-services/local-sponsorship.png",
  },
  companyFormationTypes: {
    headingRest: "Local Sponsorship Services We Offer",
    description:
      "We provide comprehensive local sponsorship support across all UAE mainland jurisdictions:",
    items: [
      {
        id: "01",
        title: "Individual Local Sponsorship",
        description:
          "UAE national sponsor for mainland companies as per activity requirements, ensuring compliant company registration and license approvals.",
      },
      {
        id: "02",
        title: "Corporate Local Sponsorship",
        description:
          "UAE-owned corporate entity acting as a sponsor to provide higher security, structured agreements, and professional representation.",
      },
      {
        id: "03",
        title: "Local Service Agent (LSA) Support",
        description:
          "For professional license holders (consultancy, services, freelancers) who require a UAE national service agent without ownership involvement.",
      },
      {
        id: "04",
        title: "Trade License Processing",
        description:
          "New mainland license applications, renewals, amendments, and activity additions through the Department of Economic Development.",
      },
      {
        id: "05",
        title: "Immigration & Labour File Setup",
        description:
          "Company establishment card, labour file opening, quota approvals, and employee eligibility processing.",
      },
    ],
  },
  whyChoose: {
    ...
    cardTitle:
      "Trusted UAE national sponsors and corporate sponsorship options",
    ...
    items: [
      {
        ...
        answer:
          "A local sponsor is a UAE national or UAE-owned company appointed to meet mainland licensing requirements, enabling foreign investors to legally operate their business.",
      },
      {
        question: "Do local sponsors control the business?",
        answer:
          "No. With proper legal agreements, the foreign investor retains full operational and financial control while the sponsor fulfills regulatory requirements.",
      },
      {
        question: "Is local sponsorship required for all businesses?",
        answer:
          "Local sponsorship is required for certain mainland activities. Many sectors now allow 100% foreign ownership, but some regulated activities still require a UAE national sponsor or service agent.",
      },
      {
        question:
          "What is the difference between a local sponsor and a local service agent?",
        answer:
          "A local sponsor is linked to commercial licenses, while a local service agent is required for professional licenses and has no ownership or control.",
      },
      {
        question: "Can the local sponsor be changed?",
        answer:
          "Yes. Local sponsorship can be transferred or amended through legal procedures and approvals from the Department of Economic Development.",
      },
    ],
  },
  authorizedPartnerStatus: {
    ...
    description:
      "Invest First provides reliable and compliant local sponsorship solutions across the UAE. Our direct coordination with mainland authorities ensures faster processing, accurate documentation, and legally secure agreements.",
    bulletPoints: [
    ...
    footerNote:
      "With our support, you can establish and operate your mainland business with confidence while we handle all sponsorship formalities.",
  },
};
...
const licenseRenewals = {
  ...
  intro: {
    ...
    description1:
      "Trade license renewal services in the UAE ensure your business remains legally active and fully compliant with government regulations. Timely renewal is mandatory to avoid penalties, visa blocks, and operational disruptions.",
    description2:
      "By coordinating with authorities such as the Department of Economic Development, Ministry of Human Resources and Emiratisation, and General Directorate of Residency and Foreigners Affairs, trade license renewal providers ensure accurate processing, quick approvals, and full regulatory compliance.",
    description3:
      "This structured approach helps startups, SMEs, and foreign investors avoid fines, maintain visa eligibility, and operate smoothly in the UAE market.",
    image: "/images/proServices/license-renewals.png",
  },
  bannerTitle: "License Renewals",
  bannerDescription:
    "Timely and hassle-free trade license renewals across all UAE jurisdictions.",
  cardTitle: "Compliance Made Easy",
  cardDescription:
    "Never miss a renewal deadline with our proactive tracking and management.",
  seo: {
    title:
      "License Renewal Services UAE | Trade License Renewal Dubai | Invest First",
    description:
    ...
    canonical:
      "http://investfirst.ae/services/pro-services/license-renewal-uae",
    ...
    items: [
      {
        ...
        description:
          "Complete renewal processing through the Department of Economic Development, including document verification and government fee submission.",
      },
      {
        id: "02",
        title: "Free Zone License Renewal",
        description:
          "End-to-end renewal support with all UAE free zones, including lease agreement updates and authority approvals.",
      },
      {
        id: "03",
        title: "Tenancy Contract (Ejari) Assistance",
        description:
          "Preparation and renewal of office lease agreements required for mainland license renewal.",
      },
      {
        id: "04",
        title: "Activity Amendment During Renewal",
        description:
          "Add, remove, or modify business activities at the time of renewal.",
      },
      {
        id: "05",
        title: "Immigration & Labour Card Renewal",
        description:
          "Renewal of establishment cards and labour files to maintain employee visa eligibility.",
      },
    ],
  },
  whyChoose: {
    ...
    items: [
      {
        ...
        answer:
          "Trade licenses must be renewed annually before the expiry date to avoid penalties and business suspension.",
      },
      {
        question: "What happens if I don’t renew my license on time?",
        answer:
          "Late renewal may result in fines, visa blocks, blacklisting of the company, and possible business closure.",
      },
      {
        question: "Is Ejari mandatory for mainland license renewal?",
        answer:
          "Yes. A valid tenancy contract (Ejari) is required for mainland trade license renewal.",
      },
      {
        question: "Can I renew my license if I have fines?",
        answer:
          "Yes, but fines must be cleared before the renewal is approved.",
      },
      {
        question: "Does license renewal affect employee visas?",
        answer:
          "Yes. An expired license can block visa renewals, new visa applications, and labour quota approvals.",
      },
    ],
  },
  authorizedPartnerStatus: {
    ...
    description:
      "Invest First delivers reliable and compliant trade license renewal services across the UAE. Our direct coordination with government authorities ensures faster approvals, accurate submissions, and complete regulatory compliance.",
    bulletPoints: [
    ...
    footerNote:
      "With our expert support, your business remains legally active, visa-eligible, and fully compliant year after year.",
  },
};

// ── 5. Visa Renewals ──────────────────────────────────────────────────
const visaRenewals = {
  slug: "visa-renewal-uae",
  intro: {
    title: "Visa Renewal <span class='text-[#0099CC]'>UAE ,Dubai</span>",
    description1:
      "Visa renewal in the UAE is essential to maintain legal residency and avoid fines, overstay penalties, or immigration blocks. Our visa renewal UAE, Dubai service ensures timely processing of employment visas, investor visas, partner visas, and family visas with complete coordination across government authorities.",
    description2:
      "By working with the General Directorate of Residency and Foreigners Affairs, Ministry of Human Resources and Emiratisation, and Emirates ID authorities, we manage the full renewal process—document verification, medical testing, Emirates ID renewal, and visa stamping—so you remain compliant without delays.",
    description3:
      "We ensure your UAE residence visa is renewed on time without disruptions to employment, business operations, or family residency.",
    image: "/images/proServices/visa-renewals.png",
  },
  bannerTitle: "Visa Renewals",
  bannerDescription:
    "Efficient visa renewal services for investors, employees, and families in the UAE.",
  cardTitle: "Seamless Visa Processing",
  cardDescription:
    "End-to-end management of renewals for residency and employment visas.",
  seo: {
    title: " Visa Renewal Services in UAE | UAE Visa Renewal Dubai",
    description:
      "Fast and reliable visa renewal services in UAE for residence, employment, and family visas with complete documentation and immigration support across Dubai and the UAE.",
    keywords:
      "visa renewal UAE, UAE visa renewal services, Dubai visa renewal, residence visa renewal UAE, employment visa renewal Dubai, family visa renewal UAE, immigration services Dubai, UAE visa processing services, business visa renewal UAE, PRO services UAE, Invest First UAE, visa consultants Dubai, UAE residency services, Dubai immigration support, visa assistance UAE ",
    ...
    items: [
      {
        ...
        description:
          "Complete renewal processing including labour contract update, medical test, Emirates ID renewal, and visa stamping.",
      },
      {
        id: "02",
        title: "Investor & Partner Visa Renewal",
        description:
          "Renewal of investor and partner residence visas linked to mainland and free zone companies.",
      },
      {
        id: "03",
        title: "Family Visa Renewal",
        description:
          "Dependent visa renewal for spouses, children, and parents with medical, insurance, and Emirates ID coordination.",
      },
      {
        id: "04",
        title: "Domestic Worker Visa Renewal",
        description:
          "Renewal of visas for housemaids, drivers, and other domestic staff in compliance with UAE regulations.",
      },
      {
        id: "05",
        title: "Free Zone Visa Renewal",
        description:
          "End-to-end renewal support with all UAE free zones, including establishment card and quota validation.",
      },
    ],
  },
  whyChoose: {
    ...
    items: [
      {
        ...
        answer:
          "Visa renewal should be initiated at least 30 days before the expiry date to avoid fines.",
      },
      {
        question: "What happens if my visa expires?",
        answer:
          "You may incur daily overstay fines and face immigration restrictions until the visa is renewed or status is changed.",
      },
      {
        question: "Is medical testing required for visa renewal?",
        answer:
          "Yes. A medical fitness test is mandatory for most residence visa renewals.",
      },
      {
        question: "Do I need to renew my Emirates ID with my visa?",
        answer:
          "Yes. Emirates ID renewal is processed together with your visa renewal.",
      },
      {
        question: "Can I renew my visa while outside the UAE?",
        answer:
          "This depends on visa type and entry status. In many cases, you must be inside the UAE for renewal processing.",
      },
    ],
  },
  authorizedPartnerStatus: {
    ...
    description:
      "Invest First provides reliable and compliant visa renewal UAE, Dubai services for individuals and companies. Our proactive tracking system, fast processing, and accurate documentation help you avoid fines, maintain legal residency, and continue your activities without interruption.",
    bulletPoints: [
    ...
    footerNote:
      "With our expert team handling your visa renewal, you can stay focused on your work and business while we manage the entire process.",
  },
};

// ── 6. Banking Assistance ─────────────────────────────────────────────
const bankingAssistance = {
  slug: "banking-assistance-uae",
  intro: {
    title:
      "Banking Assistance Services in <span class='text-[#0099CC]'>Dubai, UAE</span>",
    description1:
      "Opening a bank account in the UAE requires proper documentation, compliance checks, and coordination with local and international banks. Our banking assistance services in Dubai, UAE help businesses and individuals open corporate and personal bank accounts smoothly while meeting all regulatory and KYC requirements.",
    description2:
      "We coordinate with leading UAE banks and ensure your application meets compliance standards set by the Central Bank of the UAE, reducing rejection risks and processing delays. From document preparation to bank meetings and follow-ups, we manage the entire process for faster approvals.",
    image: "/images/proServices/banking-assistance.png",
  },
  bannerTitle: "Banking Assistance",
  bannerDescription:
    "Expert guidance for smooth corporate bank account opening and compliance in the UAE.",
  cardTitle: "Strategic Banking Support",
  cardDescription:
    "Optimizing your chances for bank account approval with professional assistance.",
  seo: {
    title: "Banking Assistance in UAE | Corporate Bank Account Support Dubai",
    description:
      "Get expert banking assistance in the UAE with Invest First. We help with corporate bank account opening, documentation, compliance, and approvals across top UAE banks in Dubai and the UAE.",
    keywords:
      " banking assistance UAE, corporate bank account UAE, business bank account Dubai, UAE banking support services, company bank account opening UAE, Dubai bank account assistance, UAE business banking services, corporate banking Dubai, bank account opening support UAE, business setup UAE banking, Invest First UAE, UAE financial services, company formation banking UAE, PRO banking services Dubai, UAE business consultants",
    canonical:
      "http://investfirst.ae/services/pro-services/banking-assistance-uae",
    ...
    items: [
      {
        ...
        description:
          "Support for mainland, free zone, and offshore companies with document structuring, KYC preparation, and bank coordination.",
      },
      {
        id: "02",
        title: "Personal Bank Account Opening",
        description:
          "Account opening assistance for UAE residents, investors, employees, and freelancers.",
      },
      {
        id: "03",
        title: "High-Risk & Startup Account Support",
        description:
          "Specialized assistance for startups, new companies, and businesses with complex activities.",
      },
      {
        id: "04",
        title: "Multi-Currency & International Banking",
        description:
          "Setup of accounts with multi-currency facilities, online banking, and international transaction capability.",
      },
      {
        id: "05",
        title: "Compliance & KYC Documentation",
        description:
          "Preparation of business plans, source of funds, shareholder profiles, and transaction forecasts required by UAE banks.",
      },
    ],
  },
  whyChoose: {
    ...
    items: [
      {
        ...
        answer:
          "Yes. UAE banks have strict compliance and KYC requirements, especially for new companies and foreign shareholders. Professional assistance improves approval chances.",
      },
      {
        question: "How long does corporate bank account opening take?",
        answer:
          "Typically 2–6 weeks, depending on the bank, business activity, and documentation.",
      },
      {
        question: "Can startups open a corporate bank account in Dubai?",
        answer:
          "Yes. With proper documentation, business plans, and compliance support, startups can successfully open accounts.",
      },
      {
        question: "Do I need to be physically present in the UAE?",
        answer:
          "Most banks require the shareholder or authorized signatory to be present for the interview.",
      },
      {
        question: "Can you help with multi-currency accounts?",
        answer:
          "Yes. We assist in opening multi-currency and international transaction-enabled bank accounts.",
      },
    ],
  },
  authorizedPartnerStatus: {
    ...
    description:
      "Invest First delivers reliable banking assistance services in Dubai, UAE with a structured and compliant approach. Our team prepares your profile to meet strict UAE banking requirements, ensuring faster approvals and long-term banking stability.",
    bulletPoints: [
...
const officeSolutions = {
    ...
    items: [
      {
        ...
        description:
          "Registered business address, mail handling, call answering, and access to meeting rooms without renting a physical office.",
      },
      {
        id: "02",
        title: "Flexi Desk Solutions",
        description:
          "Shared workspace options that meet free zone and mainland licensing requirements at minimal cost.",
      },
      {
        id: "03",
        title: "Serviced Office Spaces",
        description:
          "Fully furnished private offices with utilities, internet, reception services, and meeting room access.",
      },
      {
        id: "04",
        title: "Co-Working Spaces",
        description:
          "Flexible coworking environments for freelancers, startups, and remote teams.",
      },
      {
        id: "05",
        title: "Dedicated Office for License Requirements",
        description:
          "Physical office spaces that comply with mainland trade license regulations and Ejari requirements.",
      },
    ],
  },
  whyChoose: {
    ...
    cardTitle:
      "Why Invest First is a Leading Choice for Office Solutions in Dubai, UAE",
  ...
  faq: {
    ...
    items: [
      {
        question:
          "Is a physical office required to start a business in the UAE?",
        answer:
          "It depends on the license type. Mainland companies require a physical office, while many free zones allow flexi desk or virtual office options.",
      },
      {
        question: "Can I use a virtual office for trade license renewal?",
        answer:
          "Yes, in many free zones. Mainland businesses usually need an Ejari-registered office.",
      },
      {
        question: "What is Ejari and why is it important?",
        answer:
          "Ejari is the official tenancy registration system required for mainland trade licenses and renewals.",
      },
      {
        question:
          "Can I upgrade from a virtual office to a physical office later?",
        answer:
          "Yes. Most businesses start with a virtual or flexi desk and upgrade as they grow.",
      },
      {
        question: "Do your office solutions include meeting room access?",
        answer:
          "Yes. Virtual and serviced office packages include meeting room usage based on the selected plan.",
      },
    ],
  },
  authorizedPartnerStatus: {
    ...
    description:
      "Invest First provides compliant and flexible office solutions UAE tailored to your business structure and licensing needs. Our direct coordination with mainland and free zone authorities ensures faster approvals and seamless office setup.",
    bulletPoints: [
    ...
    footerNote:
      "With our office solutions, you can operate legally, enhance your brand image, and scale your workspace as your business grows.",
  },
};
...
export const proServicesList = [
  ...
  },
  {
    ...
    title: "Local Sponsorships",
    slug: "local-sponsership-uae",
    href: "/services/pro-services/local-sponsership-uae",
    image: "/images/proServices/local-sponsorship.png",
  },
  {
    id: 3,
    title: "License Renewals",
    slug: "license-renewal-uae",
    href: "/services/pro-services/license-renewal-uae",
    image: "/images/proServices/license-renewals.png",
  },
  {
    id: 4,
    title: "Visa Renewals",
    slug: "visa-renewal-uae",
    href: "/services/pro-services/visa-renewal-uae",
    image: "/images/proServices/visa-renewals.png",
  },
  {
    id: 5,
    title: "Banking Assistance",
    slug: "banking-assistance-uae",
    href: "/services/pro-services/banking-assistance-uae",
    image: "/images/proServices/banking-assistance.png",
  },
  {
    id: 6,
    title: "Office Solutions",
    slug: "office-solutions-uae",
    href: "/services/pro-services/office-solutions-uae",
    image: "/images/proServices/office-solutions.png",
  },
];
...
export const proServicesData = {
  ...
  description:
    "We provide professional PRO services in Dubai, including visa renewals, local sponsorship, banking assistance, and business support for smooth UAE operations.",
  services: proServicesList,
  footerText:
    "Invest First provides comprehensive PRO support to ensure your business remains compliant and operational without the need for an in-house government relations team.",
  // Include the default intro/seo for the main pro-services page
  // ...companyFormation
  seo: {
    title: "Professional PRO Services in Dubai & UAE | Invest First",
    description:
      "Get reliable and cost-effective Virtual PRO services, local sponsorships, trade license renewals, visa renewals, banking assistance, and office solutions in Dubai and the UAE.",
    keywords:
      "PRO services Dubai, virtual PRO UAE, government clearing Dubai, local sponsorship UAE, trade license renewal Dubai, visa services UAE",
